...
const SignupForm = () =>
{
    return (
        <div className="flex justify-center items-center h-screen">
            <form className="bg-slate-300 p-10 rounded shadow-md">
                <h2 className="text-2xl font-bold mb-5">Sign up</h2>
                <div className="mb-5">
                    <label htmlFor="name" className="block mb-2 font-bold text-gray-700">Name</label>
                    <input type="text" id="name" className="w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-600" />
                </div>
                <div className="mb-5">
                ...
                <button className="w-full bg-blue-600 text-white font-bold py-2 rounded-md hover:bg-blue-700 transition duration-300">Sign up</button>
                <p className="text-sm mt-3">Already have an account? <a href="#" className="text-blue-600 font-bold hover:underline">Login</a></p>
            </form>
        </div>
    )
}
